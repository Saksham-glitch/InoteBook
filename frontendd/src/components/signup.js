    ...
    const handleSubmit = async (e) => {
        ...
        try {
         ...
         if (json.success) {
                ...
                props.showAlert("Use different email and pass", "danger");
            }
        } catch (error) {
        ...
        <div className="container">
            ...
            <form onSubmit={handleSubmit}>
                <div className="mb-3">
                    ...
                    <input type="text" className="form-control" id="username" name="name" value={credentials.name} onChange={onChange} required />
                </div>
                <div className="mb-3">
